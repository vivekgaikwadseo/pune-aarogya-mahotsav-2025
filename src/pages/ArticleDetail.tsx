        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
            ...
            <div className="flex items-start gap-4">
              {article.authorImage ? (
                <div className="w-20 h-20 rounded-full bg-[#F8F9FA] p-1 flex items-center justify-center flex-shrink-0">
                  <img 
                    src={article.authorImage} 
                    alt={article.author}
                ...
                <div className="w-20 h-20 rounded-full bg-[#F8F9FA] flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                {article.authorTitle && (
                  <p className="text-[#FFC0CB] font-semibold mb-2">{article.authorTitle}</p>
                )}
                {article.authorBio && (
